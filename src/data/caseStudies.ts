  ...
  const caseStudies: CaseStudy[] = [
    {
      ...
      totalHeadcount: 55,
      summary:
        "Pengelolaan sistem keamanan 24/7 untuk rumah sakit berskala besar dengan 5 lantai, meliputi area IGD, poliklinik, dan unit-unit khusus",
      description:
        "Sebagai gambaran konkret dari kapabilitas layanan keamanan yang ditawarkan, berikut adalah contoh rencana penempatan personel untuk klien berskala besar seperti Rumah Sakit dengan total 55 personel. Rencana ini menunjukkan alokasi sumber daya yang terstruktur untuk memastikan keamanan menyeluruh selama 24 jam.",
      challenges: [
      ...
      shifts: [
        ...
        },
        {
          ...
          allocations: [
            {
              location: "IGD & Gedung Lt. 1-4",
              headcount: 5,
              description: "2 di pos IGD, 3 patroli",
            },
            { location: "VK (Ruang Bersalin)", headcount: 1 },
          ...
          items: [
            {
              name: "HT (Handy Talky)",
              quantity: 55,
              description: "1 unit untuk setiap personel",
            },
            {
              name: "Radio Base",
              quantity: 2,
              description: "Untuk pusat komando",
            },
            {
              name: "Earpiece",
              quantity: 10,
              description: "Untuk tim khusus dan pimpinan",
            },
          ],
        },
        {
      ...
      testimonial: {
        quote:
          "Tim keamanan Unit 007 telah memberikan rasa aman yang sangat dibutuhkan bagi tenaga medis dan pasien kami. Sistem penempatan personel mereka sangat terstruktur dan responsif terhadap kebutuhan rumah sakit.",
    ...
    },
    {
      ...
      totalHeadcount: 45,
      summary:
        "Manajemen kebersihan komprehensif untuk pusat perbelanjaan premium 5 lantai dengan area food court dan bioskop",
      description:
        "Studi kasus ini menggambarkan implementasi layanan cleaning service untuk pusat perbelanjaan premium dengan luas 50.000 m² yang mencakup ratusan tenant, food court besar, dan bioskop. Tim kami mengelola kebersihan 24/7 dengan standar kualitas tertinggi.",
      challenges: [
      ...
      equipment: [
        ...
        },
        {
          ...
          items: [
            {
              name: "Floor Cleaner Eco-Friendly",
              quantity: 50,
              description: "Liter/bulan",
            },
      ...
      testimonial: {
        quote:
          "Layanan cleaning dari Unit 007 membantu kami mempertahankan image premium mall kami. Mereka sangat responsif dan memahami kebutuhan spesifik area retail dengan traffic tinggi.",
    ...
    },
    {
      ...
      totalHeadcount: 35,
      summary:
        "Pengelolaan dan pelatihan tim sales B2B untuk perusahaan fintech dengan target pasar korporasi dan UKM",
      description:
        "Studi kasus ini menunjukkan bagaimana Unit 007 membantu mentransformasi tim sales perusahaan fintech untuk mencapai target akuisisi klien korporat dan meningkatkan revenue hingga 225% dalam waktu 12 bulan.",
      challenges: [
      ...
      equipment: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              quantity: 1,
              description: "HubSpot Sales Hub",
            },
            {
              name: "Analytics Platform",
              quantity: 1,
              description: "Tableau Enterprise",
            },
            {
              name: "Meeting & Demo Software",
              quantity: 35,
              description: "Zoom Business",
            },
          ],
        },
        {
      ...
      testimonial: {
        quote:
          "Tim Unit 007 berhasil mentransformasi pendekatan sales kami dari B2C ke B2B dengan sangat efektif. Metodologi mereka sangat data-driven dan hasil yang dicapai jauh melampaui ekspektasi kami.",
        author: "Rina Kartika",
        position: "CEO",
    ...
    // Studi kasus untuk produk Jasa Pengamanan & Keamanan Profesional
    {
      id: "security-pro-case",
      productId: "jasa-keamanan",
      title: "Keamanan Event VIP dan Fasilitas Perusahaan",
      clientType: "Perusahaan Swasta & Event Organizer",
      clientIndustry: "Event & Corporate Security",
      totalHeadcount: 18,
      summary:
        "Penyediaan layanan pengamanan profesional untuk event VIP dan fasilitas perusahaan dengan personel ex-TNI/Polri.",
      description:
        "Studi kasus ini menyoroti keberhasilan tim pengamanan profesional dalam menjaga keamanan event VIP berskala nasional dan fasilitas perusahaan selama 24 jam, dengan standar operasional tinggi dan respons cepat terhadap insiden.",
      challenges: [
        "Risiko keamanan tinggi pada event VIP dengan tamu penting",
        "Kebutuhan pengamanan 24/7 di fasilitas perusahaan",
        "Koordinasi tim keamanan dengan pihak internal dan eksternal",
      ],
      solutions: [
        "Penempatan personel ex-TNI/Polri berpengalaman di titik-titik strategis",
        "Pelatihan khusus untuk pengamanan event dan protokol VIP",
        "Penggunaan alat komunikasi modern dan sistem patroli terjadwal",
      ],
      results: [
        "Event berjalan lancar tanpa insiden keamanan",
        "Peningkatan rasa aman bagi tamu dan karyawan perusahaan",
        "Reputasi perusahaan meningkat di mata klien dan mitra bisnis",
      ],
      shifts: [
        {
          ...
          totalHeadcount: 6,
          leadershipStructure: ["1 Koordinator", "1 Danru"],
          allocations: [
            { location: "Pintu Masuk Utama", headcount: 2 },
            { location: "Area Event Hall", headcount: 2 },
            { location: "Parkir & Perimeter", headcount: 2 },
          ],
        },
        {
        ...
        },
        {
          ...
          leadershipStructure: ["1 Danru"],
          allocations: [
            { location: "Patroli Area Fasilitas", headcount: 3 },
            { location: "Pos Jaga Utama", headcount: 2 },
            { location: "CCTV Monitoring", headcount: 1 },
          ],
        },
      ],
      specialTeams: [
        {
          teamName: "Tim Reaksi Cepat (Quick Response)",
          totalHeadcount: 3,
          roles: [
            { title: "Komandan Tim", headcount: 1 },
            { title: "Anggota Reaksi Cepat", headcount: 2 },
          ],
          responsibilities: [
            "Penanganan insiden darurat secara cepat dan tepat",
            "Koordinasi dengan aparat keamanan setempat",
            "Evakuasi dan pengamanan tamu VIP jika diperlukan",
          ],
        },
      ],
      equipment: [
        {
          category: "Peralatan Keamanan",
          items: [
            { name: "HT (Handy Talky)", quantity: 10 },
            { name: "Seragam & Rompi", quantity: 18 },
            { name: "Metal Detector", quantity: 2 },
            { name: "Senter & Lampu Lalin", quantity: 6 },
          ],
        },
      ],
      serviceScope: [
        "Pengamanan event VIP dan fasilitas perusahaan",
        "Patroli area dan monitoring CCTV",
        "Koordinasi keamanan dengan pihak eksternal",
      ],
      testimonial: {
        quote:
          "Tim pengamanan sangat profesional dan responsif. Event berjalan aman tanpa gangguan, dan fasilitas perusahaan kami selalu terjaga keamanannya.",
        author: "Andi Pratama",
    ...
    // Studi kasus untuk produk ATK
    {
      id: "atk-office-case",
      productId: "atk-001",
      title: "Optimalisasi Pengadaan ATK di Kantor Pemerintah",
      clientType: "Instansi Pemerintah",
      clientIndustry: "Administrasi Publik",
      totalHeadcount: 30,
      summary:
        "Pengadaan ATK efisien dan hemat biaya untuk kebutuhan administrasi harian di Dinas Pendidikan.",
      description:
        "Studi kasus ini menggambarkan bagaimana pengadaan ATK secara terpusat dan terstandar dapat meningkatkan efisiensi kerja serta mengurangi pemborosan di lingkungan kantor pemerintahan.",
      challenges: [
        "Pengeluaran ATK tidak terkontrol dan sering kehabisan stok",
        "Kualitas alat tulis yang tidak konsisten",
        "Distribusi ATK ke tiap bagian sering terlambat",
      ],
      solutions: [
        "Pengadaan ATK dalam paket lengkap dan terstandar",
        "Distribusi ATK terjadwal setiap awal bulan",
        "Monitoring penggunaan ATK dengan sistem digital sederhana",
      ],
      results: [
        "Penghematan biaya ATK hingga 20% per tahun",
        "Stok ATK selalu tersedia di setiap bagian",
        "Kepuasan pegawai terhadap kualitas ATK meningkat",
      ],
      shifts: [
        {
          shiftName: "Distribusi Bulanan",
          shiftTime: "Setiap awal bulan",
          totalHeadcount: 2,
          leadershipStructure: ["1 Koordinator ATK"],
          allocations: [
            { location: "Bagian Umum", headcount: 1 },
            { location: "Bagian Kepegawaian", headcount: 1 },
          ],
        },
      ],
      specialTeams: [
        {
          teamName: "Tim Pengadaan & Distribusi",
          totalHeadcount: 3,
          roles: [
            { title: "Koordinator Pengadaan", headcount: 1 },
            { title: "Staf Distribusi", headcount: 2 },
          ],
          responsibilities: [
            "Menyusun kebutuhan ATK tiap bagian",
            "Melakukan pengadaan dan pengecekan kualitas",
            "Distribusi ATK ke seluruh bagian kantor",
          ],
        },
      ],
      equipment: [
          ...
          items: [
            {
              name: "Pulpen Gel",
              quantity: 120,
              description: "12 pcs per bagian",
            },
            { name: "Pensil 2B", quantity: 60 },
            { name: "Penghapus", quantity: 40 },
            { name: "Kertas HVS A4", quantity: 10, description: "Rim per bulan" },
            { name: "Map Plastik", quantity: 30 },
          ],
        },
      ],
      serviceScope: [
        "Pengadaan ATK terpusat",
        "Distribusi ke seluruh bagian kantor",
        "Monitoring dan pelaporan penggunaan ATK",
      ],
      testimonial: {
        quote:
          "Sejak menggunakan paket ATK lengkap, distribusi alat tulis di kantor kami jadi lebih lancar dan tidak pernah kehabisan stok. Kualitasnya juga sangat baik.",
        author: "Dewi Lestari",
