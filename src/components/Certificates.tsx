  ...
  const certificates = [
    {
      ...
      description:
        "Sertifikat sistem manajemen mutu yang memastikan konsistensi layanan berkualitas tinggi.",
      image:
    ...
    },
    {
      ...
      description:
        "Sertifikat manajemen lingkungan untuk praktik bisnis yang ramah lingkungan.",
      image:
    ...
    },
    {
      ...
      description:
        "Sertifikat badan usaha untuk layanan jasa keamanan profesional.",
      image:
  ...
  const legalDocuments = [
    {
      ...
      description:
        "Izin usaha perdagangan yang sah untuk menjalankan kegiatan bisnis.",
      status: "active",
    },
    {
      id: "tdp",
    ...
    },
    {
      ...
      description:
        "Nomor identifikasi pajak untuk kewajiban perpajakan perusahaan.",
      status: "active",
    },
    {
      id: "akta-pendirian",
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Dokumen resmi dan sertifikasi Unit 007
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 bg-blue-50 rounded-xl p-8 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-slate-600 mb-6">
              Semua sertifikat dan dokumen legalitas kami selalu diperbaharui
              dan sesuai dengan standar industri terbaru. Untuk verifikasi atau
              informasi lebih lanjut, silakan hubungi tim kami.
            </p>
