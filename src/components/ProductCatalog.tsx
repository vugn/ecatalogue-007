  ...
  const products = [
    {
      ...
      description:
        "Paket lengkap alat tulis kantor berkualitas untuk kebutuhan administrasi sehari-hari.",
      features: [
        "Pulpen gel 12 pcs",
        "Pensil 2B 6 pcs",
        "Kertas HVS A4 1 rim",
    ...
    },
    {
      ...
      description:
        "Kertas HVS A4 berkualitas tinggi 80gsm, putih bersih, cocok untuk print dokumen.",
      features: [
        "Ukuran A4 standar",
        "Gramatur 80gsm",
        "500 lembar per rim",
    ...
    },
    {
      ...
      description:
        "Beras premium kualitas terbaik, pulen, wangi, dan bergizi tinggi dari petani lokal.",
      features: [
    ...
    },
    {
      ...
      description:
        "Minyak goreng berkualitas tinggi, jernih, tidak berbau tengik.",
      features: [
    ...
    },
    {
      ...
      description:
        "Layanan pengamanan profesional dengan personel berpengalaman militer.",
      features: [
        "Personel ex-TNI/Polri",
    ...
    },
    {
      ...
      description:
        "Layanan pengawalan profesional untuk keamanan personal dan aset berharga.",
      features: [
        "Personel terlatih",
        "Pengawalan 24/7",
        "Kendaraan khusus",
    ...
    },
    {
      ...
      description:
        "Program pelatihan bela diri dan pembentukan karakter dengan metode militer.",
      features: [
    ...
    },
    {
      ...
      reviews: 18,
      image:
        "https://images.pexels.com/photos/6694800/pexels-photo-6694800.jpeg?auto=compress&cs=tinysrgb&w=800",
      description:
        "Perlengkapan tactical dan survival untuk kegiatan outdoor ekstrim dan situasi darurat.",
      features: [
        "Tahan lama",
        "Multi-fungsi",
        "Desain ergonomis",
    ...
    },
    {
      ...
      description:
        "Seragam dan atribut militer berkualitas tinggi dengan berbagai ukuran.",
      features: [
    ...
    },
    {
      ...
      reviews: 12,
      image:
        "https://images.pexels.com/photos/2412023/pexels-photo-2412023.jpeg?auto=compress&cs=tinysrgb&w=800",
      description:
        "Perlengkapan outdoor dan camping untuk aktivitas luar ruangan.",
      features: [
        "Tahan air",
        "Ringan & portable",
        "Mudah dipasang",
        ...
        {!isHomePage && (
          <div className="mb-8">
            ...
            <p className="text-lg text-slate-600">
              Temukan berbagai produk ATK, sembako, dan jasa khusus dengan harga
              terjangkau
            </p>
          </div>
        )}
        ...
        {isHomePage && (
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Pilih dari berbagai produk ATK, sembako berkualitas, dan jasa
              khusus profesional dengan harga terjangkau dari PRIMER KOPERASI
              KARTIKA BANJARMASIN.
            </p>
          </div>
        )}
            ...
            <div className="mt-16 bg-gradient-to-br from-slate-50 to-green-50 rounded-2xl p-8 lg:p-12">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
                  Didukung oleh PRIMER KOPERASI KARTIKA BANJARMASIN dengan
                  legalitas lengkap dan pelayanan terbaik untuk masyarakat umum
                  dan anggota TNI.
                </p>
